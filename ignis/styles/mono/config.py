...
TRAY_CONFIG = {
    ...
    "icon_overrides": {
        "nm-applet": "/home/arx/.config/ignis/icons/wifi-black.svg",
...
def workspace_button(workspace_id: int) -> Widget.Button:
    ...
    icon = JAPANESE_NUMBERS[workspace_id-1] if 1 <= workspace_id <= 10 else "•"
    ...
    if workspace_id == hyprland.active_workspace["id"]:
        ...
        icon = JAPANESE_NUMBERS[workspace_id-1]
